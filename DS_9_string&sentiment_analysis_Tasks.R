...
#Sentiment Analysis on Tagore and Kipling with basic string manipulation tasks
...
### Task 2: Find the longest words per Author (Top 10 longest words)


### Task 3: Frequency of the word "love" by author 
